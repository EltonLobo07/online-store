...
function Header({ user, setUser }) {
    ...
    return (
        <div className = "bg-purple-700 text-white w-full flex items-center justify-around h-12 py-1 fixed">
            ...
            <div className = "md:hidden relative">
                ...
                <div className = {`${boxHidden ? "hidden" : "block"} absolute top-9 right-0 flex flex-col text-purple-700 bg-white border border-purple-700 border-t-0`}>
